...
function parseDate (str) {
  ...
  d.setYear(num(parts[2]))
  return d
}

function parseBool (str, fieldName) {
  if (str !== '' && str !== 'X') {
    error('Invalid bool "' + str + '" for ' + fieldName)
  }
  return str === 'X'
}
...
const validLength = memoize(function (length) {
  return function (str, fieldName) {
    if (str.length > length) {
      error('Invalid length. ' + fieldName + ' max len. is ' + length + ', got ' + str.length)
    }
    return str
  }
})
...
exports.validSlog = validSlog
exports.validIBAN = validIBAN
exports.validLength = validLength
exports.validKodaNamena = validKodaNamena
